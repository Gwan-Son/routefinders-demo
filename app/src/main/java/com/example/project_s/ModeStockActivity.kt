...
class ModeStockActivity :AppCompatActivity(){
    lateinit var recyclerView: RecyclerView
    lateinit var searchStock:SearchView
    lateinit var stockAdapter: ModeRecyclerItemAdapter
        ...
        Single.fromCallable{
            ...
            .subscribe(
                ...
                { text ->
                    ...
                    stockAdapter = ModeRecyclerItemAdapter(list)
    ...
    private fun showLoadingDialog() {
        val dialog = LoadingDialog(this@ModeStockActivity)
