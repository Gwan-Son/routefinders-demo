...
class ModeCategory : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId){
            ...
            R.id.item4 ->{
                var helpDialog = AlertDialog.Builder(this@ModeCategory)
    ...
    private fun showLoadingDialog(){
        val dialog = LoadingDialog(this@ModeCategory)
